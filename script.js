...
const PROJECTS = [
  {
    ...
    duration: '4 أيام',
    team: '+180 فرد',
    desc: 'أكبر مؤتمر تقني في منطقة الشرق الأوسط وأفريقيا. أدارت أثر مناطق تجربة الزوار والتنسيق الكامل لأكثر من 100 جناح عارض، مع فريق غرفة عمليات مركزية على مدار الساعة.',
  ...
  },
  {
    ...
    duration: '3 أيام',
    team: '+95 فرد',
    desc: 'تنظيم القمة الصحية السنوية التي تجمع القيادات الصحية من المملكة والعالم. أشرفت أثر على تنسيق الجلسات العلمية والمعارض الطبية وحفلات التكريم.',
    tags: ['صحة', 'حكومي', 'علمي'],
  ...
  },
  {
    ...
    duration: '2 يوم',
    team: '+70 فرد',
    desc: 'شريك تنفيذي لمؤتمر الطاقة السنوي لأرامكو. صمّمت أثر الهوية البصرية الكاملة وأدارت تجربة الحضور المميز وتنسيق الجلسات الرئيسية والمعارض التقنية.',
...
const INSIGHTS = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h: 'خلاصة',
        p: 'المؤتمرات الدولية ليست في أزمة، بل تمر بمرحلة نضج. النموذج القديم (قاعة + متحدثين + جمهور جالس) لم يعد كافياً. المنظمون الذين يفهمون هذا التحوّل ويستثمرون فيه مبكراً، سيكونون الرواد في المرحلة القادمة. نحن في أثر نستثمر في هذه القدرات منذ سنوات، ونتائجنا في 2025-2026 تؤكد أن الاستثمار في الاتجاه الصحيح يؤتي ثماره.'
      }
    ]
  }
];
...
const FAQS = [
  { q:'ما القطاعات التي تخدمها أثر؟',       a:'نعمل مع الجهات الحكومية والهيئات والمؤسسات الخاصة والشركاء الدوليين، بمنهجية واحدة تختلف فقط في درجة الحوكمة المطلوبة.' },
...
document.addEventListener('DOMContentLoaded', () => {
  document.getElementById('footer-year').textContent =
    '© ' + new Date().getFullYear() + ' شركة أثر للحلول الإبداعية. جميع الحقوق محفوظة.';
